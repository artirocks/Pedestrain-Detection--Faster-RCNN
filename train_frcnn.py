...
parser.add_option("--output_weight_path", dest="output_weight_path", help="Output path for weights.", default='model_frcnn11.hdf5')
parser.add_option("--input_weight_path", dest="input_weight_path", help="Input path for weights. If not specified, will try to load default weights provided by keras.",default='mobilenetv1.weights.230-1.51.hdf5')
parser.add_option("--rpn", dest="rpn_weight_path", help="Input path for rpn.",default='mobilenetv1.weights.230-1.51.hdf5')
parser.add_option("--opt", dest="optimizers", help="set the optimizer to use", default="Adam")
parser.add_option("--elen", dest="epoch_length", help="set the epoch length. def=1000", default=100)
        ...
        try:
            ...
            if iter_num == epoch_length:
                ...
                if curr_loss < best_loss:
                    ...
                    best_loss = curr_loss
                    model_all.save_weights('model_frcnn.mobilenetv1.hdf5')
                break
